...
from TTS.tts.models.speaker_tts import SpeakerTTSArgs


@dataclass
class SpeakerTTSConfig(BaseTTSConfig):
    ...
    Args:
        model (str):
            Model name used for selecting the right model at initialization. Defaults to `speaker_tts`.
    ...
    model: str = "speaker_tts"
    base_model: str = ""
    device : str = None
    

    # model specific params
    model_args: SpeakerTTSArgs = SpeakerTTSArgs(
